...
CREATE TABLE `announcement` (
  `annc_id` int NOT NULL,
  `title` varchar(255) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `annc_img` varchar(255) DEFAULT NULL,
...
CREATE TABLE `order_items` (
  ...
  KEY `product_id_idx` (`pd_id`),
  CONSTRAINT `fk_orderitems_orders` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_orderitems_product` FOREIGN KEY (`pd_id`) REFERENCES `product` (`pd_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_discount` (
  ...
  `pd_id` int NOT NULL,
  `dis_type` enum('percent','amount') NOT NULL,
  ...
  PRIMARY KEY (`dis_id`),
  KEY `pd_id_idx` (`pd_id`),
  CONSTRAINT `pd_id` FOREIGN KEY (`pd_id`) REFERENCES `product` (`pd_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-20 20:42:53
